...
namespace Whatwapp.MergeSolitaire.Game.Settings
{
    ...
    {
        [Header("Block Spawn")]
        [SerializeField] private float blockSpawnDuration = 0.25f;

        [Header("Block Move")]
        [SerializeField] private float blockMoveDuration = 0.01f;
        [SerializeField] private float blockMoveDelay = 0.0025f;

        [Header("Block Merge")]
        [SerializeField] private float blockMergeDuration = 0.1f;
        ...
        [Header("Block Shake")]
        [SerializeField] private float blockShakeDuration = 0.25f;
        [SerializeField] private float blockShakeStrength = 0.1f;

        [Header("Block Explosion")]
        [SerializeField] private float explosionDuration = 0.3f;
        [SerializeField] private float explosionDelayPerDistance = 0.1f;
        [SerializeField] private float bombExplosionScale = 1.5f;
        [SerializeField] private float destroyScale = 1.2f;

        [Header("Block To Foundation")]
        [SerializeField] private float attachDuration = 0.35f;

        [Header("Cell")]
        [SerializeField] private float highlightDuration = 0.05f;
        [SerializeField] private float highlightDelay = 0.03f;

        [Header("Column")]
        [SerializeField] private float cellShakeScaleDuration = 0.2f;
        ...
        public float ExplosionDelayPerDistance => explosionDelayPerDistance;
        public float BombExplosionScale => bombExplosionScale;
        public float DestroyScale => destroyScale;
    }
}