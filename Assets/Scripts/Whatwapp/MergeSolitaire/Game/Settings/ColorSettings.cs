...
namespace Whatwapp.MergeSolitaire.Game.Settings
{
    ...
    {
        [Header("Block Colors")] [SerializeField]
        private Color[] blockColors;

        [Header("Block Sprites")] [SerializeField]
        private Sprite[] blockSprites;

        [Header("Foundation Sprites")] [SerializeField]
        private Sprite[] foundationSprites;
        ...
        [Header("Cell Colors")] [SerializeField]
